...
const ConairOutboundsMap: {[key: string]: string} = { 台灣: "TW", 台湾: "TW", 日本: "JP", 新加坡: "SG", 美國: "US", 香港: "HK", 韓國: "KR", 韩国: "KR", 加拿大: "CA", 土耳其: "TR", 俄羅斯: "RU", 印度: "IN", 法國: "FR", 德國: "DE", 阿根廷: "AR", 英國: "UK", 尼德蘭: "NL"};
